...
function twentytwelve_less_enqueue_parent() {
    wp_enqueue_style( 'parent-style', get_template_directory_uri() . '/style.css' );
}
add_action( 'wp_enqueue_scripts', 'twentytwelve_less_enqueue_parent' );


// Child theme's stylesheet: use get_stylesheet_uri()
function twentytwelve_less_enqueue_child() {
    wp_enqueue_style( 'child-style', get_stylesheet_uri() );
}
add_action( 'wp_enqueue_scripts', 'twentytwelve_less_enqueue_child', 11 );
